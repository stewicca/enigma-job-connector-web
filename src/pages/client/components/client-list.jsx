...
const ClientList = ({ data, onDelete, onChangeSearchParams, sortDirection, onSort }) => {
    return (
        <div className='flex flex-col gap-6 py-5'>
            <div className='flex items-center justify-between'>
                <SearchBar placeholder='Search client' onChangeSearchParams={onChangeSearchParams} />
                <Link to='/client/add'>
            ...
            <h1 className='text-beer text-2xl font-bold'>Client</h1>
